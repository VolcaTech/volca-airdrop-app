...
export const LinkdropVerificationDetails = ({ contractAddress, linkdropKey }) => {
    return (
        <div>
            ...
            <div style={{ ...styles.airdropBalanceContainer, width: 850, height: 238, flexDirection: 'column', padding: '40px 0px 40px 40px' }}>
                <div style={{ display: 'flex' }}>
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                      <div style={{ fontFamily: 'Inter UI Regular', fontSize: 16, marginTop: 30 }}>Contract Address:
			<div style={{ display: 'inline', color: '#0099FF', fontFamily: 'Inter UI Medium' }}> {contractAddress}</div>
                      </div>
                      <div style={{ fontFamily: 'Inter UI Regular', fontSize: 16, marginTop: 15 }}>Linkdrop Verification Key:
...
export const ContractDetails = ({ contractAddress, networkId, onSubmit, txHash, checkDeployingContract, isApproved, linkdropKey }) => (
    <div>
        {isApproved > 0 && contractAddress ?
            <LinkdropVerificationDetails contractAddress={contractAddress} linkdropKey={linkdropKey}  /> :
